...
def generate_harmonic_colors(base_colors, num_colors=5):
    harmonic_colors = []
...
num_colors = 10  # Liczba kolorów wynikowych
harmonic_colors = generate_harmonic_colors(base_colors, num_colors)

# Dodanie koloru #114444 na początku listy
harmonic_colors.insert(0, '#114444')
